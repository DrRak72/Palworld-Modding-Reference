#ifndef UE4SS_SDK_BP_BuildObject_Box_Wood_HPP
#define UE4SS_SDK_BP_BuildObject_Box_Wood_HPP

class ABP_BuildObject_Box_Wood_C : public APalBuildObject
{
    class UPalMapObjectItemChestParameterComponent* PalMapObjectItemChestParameter;   // 0x0580 (size: 0x8)
    class UStaticMeshComponent* SM_Wooden_Box_01;                                     // 0x0588 (size: 0x8)
