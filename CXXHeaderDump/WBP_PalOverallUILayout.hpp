...
class UWBP_PalOverallUILayout_C : public UPalPrimaryGameLayoutBase
{
    ...
    class UCommonActivatableWidgetStack* GameLayer_Stack;                             // 0x0320 (size: 0x8)
    class UCommonActivatableWidgetStack* GameMenu_Stack_1;                            // 0x0328 (size: 0x8)
    class UCommonActivatableWidgetStack* GameMenu_Stack_2;                            // 0x0330 (size: 0x8)
    class UCommonActivatableWidgetStack* GameMenu_Stack_3;                            // 0x0338 (size: 0x8)
    class UCommonActivatableWidgetStack* GameMenu_Stack_4;                            // 0x0340 (size: 0x8)
    class UCommonActivatableWidgetStack* GameMenu_Stack_5;                            // 0x0348 (size: 0x8)
    class UCommonActivatableWidgetStack* GameMenu_Stack_6;                            // 0x0350 (size: 0x8)
    class UCommonActivatableWidgetStack* GameMenu_Stack_7;                            // 0x0358 (size: 0x8)
    class UCommonActivatableWidgetStack* Menu_Stack;                                  // 0x0360 (size: 0x8)
    class UCommonActivatableWidgetStack* Modal_Stack;                                 // 0x0368 (size: 0x8)
