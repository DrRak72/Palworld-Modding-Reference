#ifndef UE4SS_SDK_BP_DecalBullet_3_HPP
#define UE4SS_SDK_BP_DecalBullet_3_HPP

class ABP_DecalBullet_3_C : public ABP_AttackBulletBase_C
{
    ...
    void ExecuteUbergraph_BP_DecalBullet_3(int32 EntryPoint);
}; // Size: 0x380
