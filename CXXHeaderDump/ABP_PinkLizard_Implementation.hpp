#ifndef UE4SS_SDK_ABP_PinkLizard_Implementation_HPP
#define UE4SS_SDK_ABP_PinkLizard_Implementation_HPP
...
class UABP_PinkLizard_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x0800 (size: 0x250)
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x0A90 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x0CE0 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x0F30 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x0F50 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x1018 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x10E0 (size: 0x20)
    FVector LookAtWorldLocation;                                                      // 0x1100 (size: 0x18)
    ...
    void ExecuteUbergraph_ABP_PinkLizard_Implementation(int32 EntryPoint);
}; // Size: 0x1118
