#ifndef UE4SS_SDK_BP_BuildObject_GarbageBag_Iron_HPP
#define UE4SS_SDK_BP_BuildObject_GarbageBag_Iron_HPP

class ABP_BuildObject_GarbageBag_Iron_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_garbageBag_set;                                    // 0x0580 (size: 0x8)
