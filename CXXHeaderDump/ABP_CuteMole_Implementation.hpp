#ifndef UE4SS_SDK_ABP_CuteMole_Implementation_HPP
#define UE4SS_SDK_ABP_CuteMole_Implementation_HPP
...
class UABP_CuteMole_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_CuteMole_Implementation(int32 EntryPoint);
}; // Size: 0xC78
