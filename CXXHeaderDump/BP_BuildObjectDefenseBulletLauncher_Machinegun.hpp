#ifndef UE4SS_SDK_BP_BuildObjectDefenseBulletLauncher_Machinegun_HPP
#define UE4SS_SDK_BP_BuildObjectDefenseBulletLauncher_Machinegun_HPP
...
class ABP_BuildObjectDefenseBulletLauncher_Machinegun_C : public ABP_BuildObjectDefenseBulletLauncher_Base_C
{
    ...
    void ExecuteUbergraph_BP_BuildObjectDefenseBulletLauncher_Machinegun(int32 EntryPoint);
}; // Size: 0x610
