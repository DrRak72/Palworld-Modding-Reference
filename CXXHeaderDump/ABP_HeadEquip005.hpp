#ifndef UE4SS_SDK_ABP_HeadEquip005_HPP
#define UE4SS_SDK_ABP_HeadEquip005_HPP
...
class UABP_HeadEquip005_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_HeadEquip005(int32 EntryPoint);
}; // Size: 0x5070
