...
struct FUnderwaterPostProcessSettings
{
    ...
    FPostProcessSettings PostProcessSettings;                                         // 0x0010 (size: 0x6E0)
    class UMaterialInterface* UnderwaterPostProcessMaterial;                          // 0x06F0 (size: 0x8)
...
class AWaterZone : public AActor
{
    ...
    FVector TessellatedWaterMeshExtent;                                               // 0x02D8 (size: 0x18)
    uint32 NonTessellatedLODSectionScale;                                             // 0x02F0 (size: 0x4)
    int32 OverlapPriority;                                                            // 0x02F4 (size: 0x4)
    bool bEnableNonTessellatedLODMesh;                                                // 0x02F8 (size: 0x1)
...
{
    class UBodySetup* CachedBodySetup;                                                // 0x0538 (size: 0x8)
...
{
    class UPhysicalMaterial* PhysicalMaterial;                                        // 0x0538 (size: 0x8)
    float TargetWaveMaskDepth;                                                        // 0x0540 (size: 0x4)
    float MaxWaveHeightOffset;                                                        // 0x0544 (size: 0x4)
    FUnderwaterPostProcessSettings UnderwaterPostProcessSettings;                     // 0x0550 (size: 0x700)
    FWaterCurveSettings CurveSettings;                                                // 0x0C50 (size: 0x20)
    class UMaterialInterface* WaterMaterial;                                          // 0x0C70 (size: 0x8)
    class UMaterialInterface* WaterHLODMaterial;                                      // 0x0C78 (size: 0x8)
    class UMaterialInterface* WaterLODMaterial;                                       // 0x0C80 (size: 0x8)
    class UMaterialInterface* UnderwaterPostProcessMaterial;                          // 0x0C88 (size: 0x8)
    class UMaterialInterface* WaterInfoMaterial;                                      // 0x0C90 (size: 0x8)
    FWaterBodyHeightmapSettings WaterHeightmapSettings;                               // 0x0C98 (size: 0x80)
    float ShapeDilation;                                                              // 0x0D18 (size: 0x4)
    float CollisionHeightOffset;                                                      // 0x0D1C (size: 0x4)
    bool bAffectsLandscape;                                                           // 0x0D20 (size: 0x1)
    int32 WaterBodyIndex;                                                             // 0x0D24 (size: 0x4)
    class UStaticMesh* WaterMeshOverride;                                             // 0x0D28 (size: 0x8)
    bool bAlwaysGenerateWaterMeshTiles;                                               // 0x0D30 (size: 0x1)
    int32 OverlapMaterialPriority;                                                    // 0x0D34 (size: 0x4)
    class UWaterSplineMetadata* WaterSplineMetadata;                                  // 0x0D38 (size: 0x8)
    class UMaterialInstanceDynamic* WaterMID;                                         // 0x0D40 (size: 0x8)
...
{
    class UStaticMeshComponent* MeshComp;                                             // 0x1530 (size: 0x8)
...
{
    class UStaticMeshComponent* LakeMeshComp;                                         // 0x1530 (size: 0x8)
    class ULakeCollisionComponent* LakeCollision;                                     // 0x1538 (size: 0x8)
...
class UWaterBodyRiverComponent : public UWaterBodyComponent
{
    ...
    class UMaterialInstanceDynamic* OceanTransitionMID;                               // 0x1558 (size: 0x8)

}; // Size: 0x1560

class UWaterMeshComponent : public UMeshComponent
{
    int32 ForceCollapseDensityLevel;                                                  // 0x0570 (size: 0x4)
    class UMaterialInterface* FarDistanceMaterial;                                    // 0x0578 (size: 0x8)
    float FarDistanceMeshExtent;                                                      // 0x0580 (size: 0x4)
    float TileSize;                                                                   // 0x0584 (size: 0x4)
    FIntPoint ExtentInTiles;                                                          // 0x0588 (size: 0x8)
    TSet<UMaterialInterface*> UsedMaterials;                                          // 0x0628 (size: 0x50)
    int32 TessellationFactor;                                                         // 0x0688 (size: 0x4)
    float LODScale;                                                                   // 0x068C (size: 0x4)
...
{
    FWaterSplineCurveDefaults WaterSplineDefaults;                                    // 0x0638 (size: 0x10)
    FWaterSplineCurveDefaults PreviousWaterSplineDefaults;                            // 0x0648 (size: 0x10)
