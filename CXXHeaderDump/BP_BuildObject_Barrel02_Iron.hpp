#ifndef UE4SS_SDK_BP_BuildObject_Barrel02_Iron_HPP
#define UE4SS_SDK_BP_BuildObject_Barrel02_Iron_HPP

class ABP_BuildObject_Barrel02_Iron_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_barrel2;                                           // 0x0580 (size: 0x8)
