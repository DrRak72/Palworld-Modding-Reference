#ifndef UE4SS_SDK_BP_BuildObject_Well_HPP
#define UE4SS_SDK_BP_BuildObject_Well_HPP

class ABP_BuildObject_Well_C : public APalBuildObject
{
    class UPalMapObjectItemSimpleProductParameterComponent* ItemSimpleProductParameter; // 0x0580 (size: 0x8)
