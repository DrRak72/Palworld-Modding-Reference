#ifndef UE4SS_SDK_ABP_TestNPC_Standard_HPP
#define UE4SS_SDK_ABP_TestNPC_Standard_HPP
...
class UABP_TestNPC_Standard_C : public UAnimInstance
{
    ...
    class UAnimSequence* PlayAnimSequence;                                            // 0x03D0 (size: 0x8)

    void AnimGraph(FPoseLink& AnimGraph);
    void BlueprintUpdateAnimation(float DeltaTimeX);
    void ExecuteUbergraph_ABP_TestNPC_Standard(int32 EntryPoint);
}; // Size: 0x3D8
