...
class UWBP_Menu_PalList_C : public UWBP_IndividualParameterBindWidget_C
{
    ...
    class UWidgetAnimation* Anm_EmptyNormalToFocus;                                   // 0x05B8 (size: 0x8)
    class UWidgetAnimation* Anm_NormalToFocus;                                        // 0x05C0 (size: 0x8)
    class UWidgetAnimation* Anm_Open_normal;                                          // 0x05C8 (size: 0x8)
    class UWidgetAnimation* Anm_Normal;                                               // 0x05D0 (size: 0x8)
    class UWidgetAnimation* Anm_Focus;                                                // 0x05D8 (size: 0x8)
    class UWidgetAnimation* Anm_Push;                                                 // 0x05E0 (size: 0x8)
    class UWidgetAnimation* Anm_Open_focus;                                           // 0x05E8 (size: 0x8)
    class UImage* Empty;                                                              // 0x05F0 (size: 0x8)
    class UImage* Image_Icon;                                                         // 0x05F8 (size: 0x8)
    class UProgressBar* ProgressBar_219;                                              // 0x0600 (size: 0x8)
    class UProgressBar* ProgressBar_Hunger;                                           // 0x0608 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Pal_hp_L;                                          // 0x0610 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Pal_hp_R;                                          // 0x0618 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Pal_Level;                                         // 0x0620 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Pal_LvText;                                        // 0x0628 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Pal_name;                                          // 0x0630 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton;                          // 0x0638 (size: 0x8)
    FWBP_Menu_PalList_COnClickedPanel OnClickedPanel;                                 // 0x0640 (size: 0x10)
    void OnClickedPanel(class UPalIndividualCharacterHandle* Handle);
    FWBP_Menu_PalList_COnHoveredPanel OnHoveredPanel;                                 // 0x0650 (size: 0x10)
    void OnHoveredPanel(class UPalIndividualCharacterHandle* Handle);
    EPalWazaID CurrentWazaIdToUse;                                                    // 0x0660 (size: 0x1)
    FWBP_Menu_PalList_COnUnhoveredPanel OnUnhoveredPanel;                             // 0x0668 (size: 0x10)
    void OnUnhoveredPanel();
    bool Interactable;                                                                // 0x0678 (size: 0x1)
    class UAkAudioEvent* ClickEventTmp;                                               // 0x0680 (size: 0x8)
