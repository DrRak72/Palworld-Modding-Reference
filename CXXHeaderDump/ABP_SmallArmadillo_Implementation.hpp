#ifndef UE4SS_SDK_ABP_SmallArmadillo_Implementation_HPP
#define UE4SS_SDK_ABP_SmallArmadillo_Implementation_HPP
...
class UABP_SmallArmadillo_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x0800 (size: 0x250)
    ...
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x0A90 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x0AB0 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x0B78 (size: 0xC8)
    ...
    void ExecuteUbergraph_ABP_SmallArmadillo_Implementation(int32 EntryPoint);
}; // Size: 0xC78
