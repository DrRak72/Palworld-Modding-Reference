#ifndef UE4SS_SDK_BP_IceFox_HPP
#define UE4SS_SDK_BP_IceFox_HPP

class ABP_IceFox_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule3;                        // 0x0A10 (size: 0x8)
