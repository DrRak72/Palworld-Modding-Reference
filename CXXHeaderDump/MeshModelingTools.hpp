...
{
    class UCutMeshWithMeshToolProperties* CutProperties;                              // 0x0100 (size: 0x8)
    class UPreviewMesh* IntersectPreviewMesh;                                         // 0x0108 (size: 0x8)
    class ULineSetComponent* DrawnLineSet;                                            // 0x0130 (size: 0x8)
...
class UDrawPolygonTool : public UInteractiveTool
{
    ...
    class UPreviewMesh* PreviewMesh;                                                  // 0x0190 (size: 0x8)
    class UCombinedTransformGizmo* PlaneTransformGizmo;                               // 0x0198 (size: 0x8)
    class UTransformProxy* PlaneTransformProxy;                                       // 0x01A0 (size: 0x8)
    class UPlaneDistanceFromHitMechanic* HeightMechanic;                              // 0x0588 (size: 0x8)
    class UDragAlignmentMechanic* DragAlignmentMechanic;                              // 0x0590 (size: 0x8)
...
class UEditMeshPolygonsTool : public USingleSelectionMeshEditingTool
{
    ...
    class UPolyEditCommonProperties* CommonProps;                                     // 0x00E8 (size: 0x8)
    class UEditMeshPolygonsToolActions* EditActions;                                  // 0x00F0 (size: 0x8)
    class UEditMeshPolygonsToolActions_Triangles* EditActions_Triangles;              // 0x00F8 (size: 0x8)
    class UEditMeshPolygonsToolEdgeActions* EditEdgeActions;                          // 0x0100 (size: 0x8)
    class UEditMeshPolygonsToolEdgeActions_Triangles* EditEdgeActions_Triangles;      // 0x0108 (size: 0x8)
    class UEditMeshPolygonsToolUVActions* EditUVActions;                              // 0x0110 (size: 0x8)
    class UEditMeshPolygonsToolCancelAction* CancelAction;                            // 0x0118 (size: 0x8)
    class UEditMeshPolygonsToolAcceptCancelAction* AcceptCancelAction;                // 0x0120 (size: 0x8)
    class UPolyEditTopologyProperties* TopologyProperties;                            // 0x0128 (size: 0x8)
    class UPolyEditExtrudeActivity* ExtrudeActivity;                                  // 0x0130 (size: 0x8)
    class UPolyEditInsetOutsetActivity* InsetOutsetActivity;                          // 0x0138 (size: 0x8)
    class UPolyEditCutFacesActivity* CutFacesActivity;                                // 0x0140 (size: 0x8)
    class UPolyEditPlanarProjectionUVActivity* PlanarProjectionUVActivity;            // 0x0148 (size: 0x8)
    class UPolyEditInsertEdgeActivity* InsertEdgeActivity;                            // 0x0150 (size: 0x8)
    class UPolyEditInsertEdgeLoopActivity* InsertEdgeLoopActivity;                    // 0x0158 (size: 0x8)
    class UPolyEditBevelEdgeActivity* BevelEdgeActivity;                              // 0x0160 (size: 0x8)
    class UPolyEditActivityContext* ActivityContext;                                  // 0x01A0 (size: 0x8)
    class UPolygonSelectionMechanic* SelectionMechanic;                               // 0x01A8 (size: 0x8)
    class UDragAlignmentMechanic* DragAlignmentMechanic;                              // 0x01B0 (size: 0x8)
    class UCombinedTransformGizmo* TransformGizmo;                                    // 0x01B8 (size: 0x8)
    class UTransformProxy* TransformProxy;                                            // 0x01C0 (size: 0x8)
...
class UPolyEditExtrudeProperties : public UInteractiveToolPropertySet
{
    ...
    EPolyEditExtrudeDirection Direction;                                              // 0x00B8 (size: 0x4)
    EPolyEditExtrudeDirection MeasureDirection;                                       // 0x00BC (size: 0x4)
    bool bShellsToSolids;                                                             // 0x00C0 (size: 0x1)
    EPolyEditExtrudeModeOptions DirectionMode;                                        // 0x00C4 (size: 0x4)
    double MaxDistanceScaleFactor;                                                    // 0x00C8 (size: 0x8)
...
class UProceduralRectangleToolProperties : public UProceduralShapeToolProperties
{
    ...
    int32 WidthSubdivisions;                                                          // 0x00C4 (size: 0x4)
    int32 DepthSubdivisions;                                                          // 0x00C8 (size: 0x4)
    float CornerRadius;                                                               // 0x00CC (size: 0x4)
    int32 CornerSlices;                                                               // 0x00D0 (size: 0x4)
...
{
    class UMeshUVChannelProperties* UVChannelProperties;                              // 0x00B8 (size: 0x8)
    class UUVProjectionToolProperties* BasicProperties;                               // 0x00C0 (size: 0x8)
    class UUVProjectionToolEditActions* EditActions;                                  // 0x00C8 (size: 0x8)
    class UExistingMeshMaterialProperties* MaterialSettings;                          // 0x00D0 (size: 0x8)
    class UMeshOpPreviewWithBackgroundCompute* Preview;                               // 0x00D8 (size: 0x8)
    class UMaterialInstanceDynamic* CheckerMaterial;                                  // 0x00E0 (size: 0x8)
    class UCombinedTransformGizmo* TransformGizmo;                                    // 0x00E8 (size: 0x8)
    class UTransformProxy* TransformProxy;                                            // 0x00F0 (size: 0x8)
    class UUVProjectionOperatorFactory* OperatorFactory;                              // 0x00F8 (size: 0x8)
    class UPreviewGeometry* EdgeRenderer;                                             // 0x0100 (size: 0x8)
    class USingleClickInputBehavior* ClickToSetPlaneBehavior;                         // 0x0438 (size: 0x8)
...
class UUVProjectionToolProperties : public UInteractiveToolPropertySet
{
    ...
    bool bUniformDimensions;                                                          // 0x00C8 (size: 0x1)
    ...
    bool bSavedUniformDimensions;                                                     // 0x0120 (size: 0x1)
