#ifndef UE4SS_SDK_BP_BuildObjectDefenseBulletLauncher_BowGun_HPP
#define UE4SS_SDK_BP_BuildObjectDefenseBulletLauncher_BowGun_HPP
...
class ABP_BuildObjectDefenseBulletLauncher_BowGun_C : public ABP_BuildObjectDefenseBulletLauncher_Base_C
{
    ...
    void ExecuteUbergraph_BP_BuildObjectDefenseBulletLauncher_BowGun(int32 EntryPoint);
}; // Size: 0x610
