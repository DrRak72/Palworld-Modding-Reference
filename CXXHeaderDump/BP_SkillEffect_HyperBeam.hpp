#ifndef UE4SS_SDK_BP_SkillEffect_HyperBeam_HPP
#define UE4SS_SDK_BP_SkillEffect_HyperBeam_HPP

class ABP_SkillEffect_HyperBeam_C : public ABP_SkillEffectBase_C
{
    ...
    void EndCollision();
    void ExecuteUbergraph_BP_SkillEffect_HyperBeam(int32 EntryPoint);
}; // Size: 0x3F0
