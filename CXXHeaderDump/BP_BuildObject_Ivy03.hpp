#ifndef UE4SS_SDK_BP_BuildObject_Ivy03_HPP
#define UE4SS_SDK_BP_BuildObject_Ivy03_HPP

class ABP_BuildObject_Ivy03_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_Ivy09;                                             // 0x0580 (size: 0x8)
