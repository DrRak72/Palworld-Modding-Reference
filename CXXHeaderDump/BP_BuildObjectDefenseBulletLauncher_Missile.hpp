#ifndef UE4SS_SDK_BP_BuildObjectDefenseBulletLauncher_Missile_HPP
#define UE4SS_SDK_BP_BuildObjectDefenseBulletLauncher_Missile_HPP

class ABP_BuildObjectDefenseBulletLauncher_Missile_C : public ABP_BuildObjectDefenseBulletLauncher_Base_C
{
    ...
    void ExecuteUbergraph_BP_BuildObjectDefenseBulletLauncher_Missile(int32 EntryPoint);
}; // Size: 0x610
