#ifndef UE4SS_SDK_ABP_FairyDragon_Implementation_HPP
#define UE4SS_SDK_ABP_FairyDragon_Implementation_HPP
...
class UABP_FairyDragon_Implementation_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_FairyDragon_Implementation(int32 EntryPoint);
}; // Size: 0x9B8
