#ifndef UE4SS_SDK_BP_Explosion_FragGrenade_Fire_HPP
#define UE4SS_SDK_BP_Explosion_FragGrenade_Fire_HPP
...
class ABP_Explosion_FragGrenade_Fire_C : public ABP_ExplosionAttackBase_C
{
    ...
    void ExecuteUbergraph_BP_Explosion_FragGrenade_Fire(int32 EntryPoint);
}; // Size: 0x2E0
