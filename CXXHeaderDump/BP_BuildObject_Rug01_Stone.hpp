#ifndef UE4SS_SDK_BP_BuildObject_Rug01_Stone_HPP
#define UE4SS_SDK_BP_BuildObject_Rug01_Stone_HPP

class ABP_BuildObject_Rug01_Stone_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_Carpet04;                                          // 0x0580 (size: 0x8)
