#ifndef UE4SS_SDK_BP_IceDeer_HPP
#define UE4SS_SDK_BP_IceDeer_HPP

class ABP_IceDeer_C : public ABP_MonsterBase_C
{
    ...
    class UBP_PalRideMarkerBiggerHorse_C* BP_PalRideMarkerBiggerHorse;                // 0x0A38 (size: 0x8)
