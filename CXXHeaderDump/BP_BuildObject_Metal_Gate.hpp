#ifndef UE4SS_SDK_BP_BuildObject_Metal_Gate_HPP
#define UE4SS_SDK_BP_BuildObject_Metal_Gate_HPP

class ABP_BuildObject_Metal_Gate_C : public APalBuildObject
{
    ...
    float _______RotateDoor_7077C602445083C73A22A1A07E78537B;                         // 0x05D0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ________Direction_7077C602445083C73A22A1A07E78537B; // 0x05D4 (size: 0x1)
    ...
    void ExecuteUbergraph_BP_BuildObject_Metal_Gate(int32 EntryPoint);
}; // Size: 0x5E0
