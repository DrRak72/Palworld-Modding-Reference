#ifndef UE4SS_SDK_BP_BuildObject_Rug_Wood_HPP
#define UE4SS_SDK_BP_BuildObject_Rug_Wood_HPP

class ABP_BuildObject_Rug_Wood_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_Rug_Deer;                                          // 0x0580 (size: 0x8)
