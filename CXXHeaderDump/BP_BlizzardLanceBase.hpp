...
class ABP_BlizzardLanceBase_C : public ABP_SkillEffectBase_C
{
    ...
    class UCapsuleComponent* BlockingCapsule;                                         // 0x03C8 (size: 0x8)
    class UNiagaraComponent* NS_SkillSign04;                                          // 0x03D0 (size: 0x8)
    class UNiagaraComponent* MainEffect;                                              // 0x03D8 (size: 0x8)
    class UNiagaraComponent* OmenEffect;                                              // 0x03E0 (size: 0x8)
    class UCapsuleComponent* AttackCapsule;                                           // 0x03E8 (size: 0x8)
    class UNiagaraSystem* ThunderEffect;                                              // 0x03F0 (size: 0x8)
    double ShootInterval;                                                             // 0x03F8 (size: 0x8)
    double CollisitionEnableTime;                                                     // 0x0400 (size: 0x8)
    class UMaterialInterface* Decal Material;                                         // 0x0408 (size: 0x8)
    FVector DecalLocationOffset;                                                      // 0x0410 (size: 0x18)
    TSubclassOf<class UCameraShakeBase> CameraShakeClass;                             // 0x0428 (size: 0x8)
