...
class UWBP_IngameMenu_WorkSpace_C : public UPalUIPaldex
{
    ...
    class UImage* Image_97;                                                           // 0x04E8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_ItemNumTitle;                                      // 0x04F0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_ItemNumValue;                                      // 0x04F8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_ManMonth_Value;                                    // 0x0500 (size: 0x8)
    class UWBP_ConvertItemMenuScrollList_C* WBP_ConvertItemMenuScrollList;            // 0x0508 (size: 0x8)
    class UWBP_IngameMenu_WorkSpace_StartButton_C* WBP_IngameMenu_StartButton;        // 0x0510 (size: 0x8)
    class UWBP_IngameMenu_WorkSpace_NumArrow_C* WBP_IngameMenu_WorkSpace_Add;         // 0x0518 (size: 0x8)
    class UWBP_IngameMenu_WorkSpace_NumArrow_C* WBP_IngameMenu_WorkSpace_Add10;       // 0x0520 (size: 0x8)
    class UWBP_IngameMenu_WorkSpace_NumArrow_C* WBP_IngameMenu_WorkSpace_Sub;         // 0x0528 (size: 0x8)
    class UWBP_IngameMenu_WorkSpace_NumArrow_C* WBP_IngameMenu_WorkSpace_Sub10;       // 0x0530 (size: 0x8)
    class UWBP_InventoryEquipment_ItemInfo_Tecnology_C* WBP_InventoryEquipment_ItemInfo_Tecnology; // 0x0538 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x0540 (size: 0x8)
    class UWBP_PalInGameMenuItemIcon_C* WBP_PalInGameMenuItemIcon;                    // 0x0548 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton;                          // 0x0550 (size: 0x8)
    class UBP_PalUIConvertItemModel_C* Convert Item Model;                            // 0x0558 (size: 0x8)
    int32 CurrentProductAmount;                                                       // 0x0560 (size: 0x4)
    FName InputActionName_Max;                                                        // 0x0564 (size: 0x8)
    bool IsSelectingProductNumFlag;                                                   // 0x056C (size: 0x1)
    class UWBP_PalConvertItemMenu_RecipeSlotButton_C* LastSelectedSlot;               // 0x0570 (size: 0x8)
    FName InputActionName_Start;                                                      // 0x0578 (size: 0x8)
    FName InputActionName_Cancel;                                                     // 0x0580 (size: 0x8)
    TArray<FPalStaticItemIdAndNum> TmpComtrollableBlueprintInfo;                      // 0x0588 (size: 0x10)
    FTimerHandle UpdateRecipeTimer;                                                   // 0x0598 (size: 0x8)
