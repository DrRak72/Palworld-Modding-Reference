#ifndef UE4SS_SDK_ABP_ThunderBird_Implementation_HPP
#define UE4SS_SDK_ABP_ThunderBird_Implementation_HPP
...
class UABP_ThunderBird_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_ThunderBird_Implementation(int32 EntryPoint);
}; // Size: 0xC78
