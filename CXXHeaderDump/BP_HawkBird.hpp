#ifndef UE4SS_SDK_BP_HawkBird_HPP
#define UE4SS_SDK_BP_HawkBird_HPP

class ABP_HawkBird_C : public ABP_MonsterBase_C
{
    ...
    class UBP_PalRideMarkerSaddle_C* BP_PalRideMarkerSaddle;                          // 0x0A48 (size: 0x8)
