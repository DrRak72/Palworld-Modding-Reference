#ifndef UE4SS_SDK_BP_BuildObject_Ivy01_HPP
#define UE4SS_SDK_BP_BuildObject_Ivy01_HPP

class ABP_BuildObject_Ivy01_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_Ivy12;                                             // 0x0580 (size: 0x8)
