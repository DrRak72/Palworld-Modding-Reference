#ifndef UE4SS_SDK_ABP_RedArmorBird_Implementation_HPP
#define UE4SS_SDK_ABP_RedArmorBird_Implementation_HPP
...
class UABP_RedArmorBird_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x0A70 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x0CC0 (size: 0x250)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x0F10 (size: 0x20)
