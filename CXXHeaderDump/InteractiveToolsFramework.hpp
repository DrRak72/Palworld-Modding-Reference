...
class ACombinedTransformGizmoActor : public AGizmoActor
{
    ...
    class UPrimitiveComponent* UniformScale;                                          // 0x02E0 (size: 0x8)
    class UPrimitiveComponent* AxisScaleX;                                            // 0x02E8 (size: 0x8)
    class UPrimitiveComponent* AxisScaleY;                                            // 0x02F0 (size: 0x8)
    class UPrimitiveComponent* AxisScaleZ;                                            // 0x02F8 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleYZ;                                          // 0x0300 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleXZ;                                          // 0x0308 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleXY;                                          // 0x0310 (size: 0x8)
...
class UBaseBrushTool : public UMeshSurfacePointTool
{
    ...
    FBrushStampData LastBrushStamp;                                                   // 0x0110 (size: 0x128)
    TSoftClassPtr<UBrushBaseProperties> PropertyClass;                                // 0x0248 (size: 0x30)
...
class UCombinedTransformGizmo : public UInteractiveGizmo
{
    ...
    bool bGridSizeIsExplicit;                                                         // 0x0041 (size: 0x1)
    ...
    class UGizmoComponentAxisSource* AxisZSource;                                     // 0x01A8 (size: 0x8)
    class UGizmoComponentAxisSource* UnitAxisXSource;                                 // 0x01B0 (size: 0x8)
    class UGizmoComponentAxisSource* UnitAxisYSource;                                 // 0x01B8 (size: 0x8)
    class UGizmoComponentAxisSource* UnitAxisZSource;                                 // 0x01C0 (size: 0x8)
    class UGizmoTransformChangeStateTarget* StateTarget;                              // 0x01C8 (size: 0x8)
...
class UGizmoArrowComponent : public UGizmoBaseComponent
{
    ...
    float Gap;                                                                        // 0x0580 (size: 0x4)
    float Length;                                                                     // 0x0584 (size: 0x4)
    float Thickness;                                                                  // 0x0588 (size: 0x4)
...
class UGizmoAxisRotationParameterSource : public UGizmoBaseFloatParameterSource
{
    ...
    FVector CurRotationAxis;                                                          // 0x00C0 (size: 0x18)
    FVector CurRotationOrigin;                                                        // 0x00D8 (size: 0x18)
    FTransform InitialTransform;                                                      // 0x00F0 (size: 0x60)
...
class UGizmoAxisTranslationParameterSource : public UGizmoBaseFloatParameterSource
{
    ...
    FGizmoFloatParameterChange LastChange;                                            // 0x00B4 (size: 0x8)
    FVector CurTranslationAxis;                                                       // 0x00C0 (size: 0x18)
    FVector CurTranslationOrigin;                                                     // 0x00D8 (size: 0x18)
    FTransform InitialTransform;                                                      // 0x00F0 (size: 0x60)
...
{
    FLinearColor Color;                                                               // 0x0538 (size: 0x10)
    float HoverSizeMultiplier;                                                        // 0x0548 (size: 0x4)
    float PixelHitDistanceThreshold;                                                  // 0x054C (size: 0x4)
    class UGizmoViewContext* GizmoViewContext;                                        // 0x0558 (size: 0x8)
...
{
    FVector Origin;                                                                   // 0x0568 (size: 0x18)
    FQuat Rotation;                                                                   // 0x0580 (size: 0x20)
    FVector Dimensions;                                                               // 0x05A0 (size: 0x18)
    float LineThickness;                                                              // 0x05B8 (size: 0x4)
    bool bRemoveHiddenLines;                                                          // 0x05BC (size: 0x1)
    bool bEnableAxisFlip;                                                             // 0x05BD (size: 0x1)

}; // Size: 0x5C0

class UGizmoCircleComponent : public UGizmoBaseComponent
{
    FVector Normal;                                                                   // 0x0568 (size: 0x18)
    float Radius;                                                                     // 0x0580 (size: 0x4)
    float Thickness;                                                                  // 0x0584 (size: 0x4)
    int32 NumSides;                                                                   // 0x0588 (size: 0x4)
    bool bViewAligned;                                                                // 0x058C (size: 0x1)
    bool bDrawFullCircle;                                                             // 0x058D (size: 0x1)
    bool bOnlyAllowFrontFacingHits;                                                   // 0x058E (size: 0x1)
...
{
    FVector Normal;                                                                   // 0x0568 (size: 0x18)
    float HandleSize;                                                                 // 0x0580 (size: 0x4)
    float Thickness;                                                                  // 0x0584 (size: 0x4)
    FVector Direction;                                                                // 0x0588 (size: 0x18)
    float Length;                                                                     // 0x05A0 (size: 0x4)
    bool bImageScale;                                                                 // 0x05A4 (size: 0x1)
...
class UGizmoPlaneTranslationParameterSource : public UGizmoBaseVec2ParameterSource
{
    TScriptInterface<class IGizmoAxisSource> AxisSource;                              // 0x0090 (size: 0x10)
    TScriptInterface<class IGizmoTransformSource> TransformSource;                    // 0x00A0 (size: 0x10)
    FVector2D Parameter;                                                              // 0x00B0 (size: 0x10)
    FGizmoVec2ParameterChange LastChange;                                             // 0x00C0 (size: 0x20)
    FVector CurTranslationOrigin;                                                     // 0x00E0 (size: 0x18)
    FVector CurTranslationNormal;                                                     // 0x00F8 (size: 0x18)
    FVector CurTranslationAxisX;                                                      // 0x0110 (size: 0x18)
    FVector CurTranslationAxisY;                                                      // 0x0128 (size: 0x18)
...
{
    FVector DirectionX;                                                               // 0x0568 (size: 0x18)
    FVector DirectionY;                                                               // 0x0580 (size: 0x18)
    bool bOrientYAccordingToCamera;                                                   // 0x0598 (size: 0x1)
    float OffsetX;                                                                    // 0x059C (size: 0x4)
    float OffsetY;                                                                    // 0x05A0 (size: 0x4)
    float LengthX;                                                                    // 0x05A4 (size: 0x4)
    float LengthY;                                                                    // 0x05A8 (size: 0x4)
    float Thickness;                                                                  // 0x05AC (size: 0x4)
    uint8 SegmentFlags;                                                               // 0x05B0 (size: 0x1)
...
class UInteractiveToolsContext : public UObject
{
    ...
    TSoftClassPtr<UInteractiveToolManager> ToolManagerClass;                          // 0x0300 (size: 0x30)
...
{
    class UGizmoTransformChangeStateTarget* RepositionStateTarget;                    // 0x0330 (size: 0x8)
