#ifndef UE4SS_SDK_ABP_ElecLion_Implementation_HPP
#define UE4SS_SDK_ABP_ElecLion_Implementation_HPP
...
class UABP_ElecLion_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_ElecLion_Implementation(int32 EntryPoint);
}; // Size: 0xC78
