...
class UWBP_CommonButton_C : public UUserWidget
{
    ...
    FWBP_CommonButton_COnClicked OnClicked;                                           // 0x02A8 (size: 0x10)
    void OnClicked();
    bool Is First Focus Target;                                                       // 0x02B8 (size: 0x1)
    FWBP_CommonButton_COnHovered OnHovered;                                           // 0x02C0 (size: 0x10)
    void OnHovered();
    FWBP_CommonButton_COnUnhovered OnUnhovered;                                       // 0x02D0 (size: 0x10)
    void OnUnhovered();
