...
class ABP_NPCAIController_Visitor_C : public ABP_NPCAIController_C
{
    ...
    FVector GoalLocation;                                                             // 0x0590 (size: 0x18)
    int32 ReturnTimeMinutes;                                                          // 0x05A8 (size: 0x4)
    int32 WalkAreaSplitNum;                                                           // 0x05AC (size: 0x4)
    EPalIVisitorNPCAction ActionTimeLimit;                                            // 0x05B0 (size: 0x1)
