...
struct FStructSerializerObjectTestStruct
{
    ...
    TSoftClassPtr<UMetaData> SoftClass;                                               // 0x0018 (size: 0x30)
...
struct FStructSerializerTestStruct
{
    ...
    FStructSerializerObjectTestStruct Objects;                                        // 0x0038 (size: 0xD0)
    FStructSerializerBuiltinTestStruct Builtins;                                      // 0x0110 (size: 0xD0)
    FStructSerializerArrayTestStruct Arrays;                                          // 0x01E0 (size: 0x60)
    FStructSerializerMapTestStruct Maps;                                              // 0x0240 (size: 0x140)
    FStructSerializerSetTestStruct Sets;                                              // 0x0380 (size: 0x140)
    FStructSerializerLWCTypesTest LWCTypes;                                           // 0x04C0 (size: 0x360)
