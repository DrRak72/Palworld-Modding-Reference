#ifndef UE4SS_SDK_BP_BuildObject_Light_LightPole01_HPP
#define UE4SS_SDK_BP_BuildObject_Light_LightPole01_HPP

class ABP_BuildObject_Light_LightPole01_C : public ABP_BuildObject_Lamp_Base_C
{
    class UStaticMeshComponent* SM_LightPole_A2;                                      // 0x0590 (size: 0x8)
