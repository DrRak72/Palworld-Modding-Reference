...
class UWBP_IngameMenu_PalBox_PalList_C : public UWBP_IndividualParameterBindWidget_C
{
    ...
    class UWidgetAnimation* Anm_NormalToFocus;                                        // 0x0580 (size: 0x8)
    class UWidgetAnimation* Anm_Focus;                                                // 0x0588 (size: 0x8)
    class UWidgetAnimation* Anm_Normal;                                               // 0x0590 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_LvText;                                 // 0x0598 (size: 0x8)
    class UCanvasPanel* CanvasPanel_119;                                              // 0x05A0 (size: 0x8)
    class UProgressBar* Gauge_HP;                                                     // 0x05A8 (size: 0x8)
    class UProgressBar* Gauge_Hunger;                                                 // 0x05B0 (size: 0x8)
    class UImage* Image_HP_Bar;                                                       // 0x05B8 (size: 0x8)
    class UImage* Image_Huger_Bar;                                                    // 0x05C0 (size: 0x8)
    class UImage* PalIcon;                                                            // 0x05C8 (size: 0x8)
    class URetainerBox* RetainerBox_0;                                                // 0x05D0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_HP;                                                // 0x05D8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_LevelValue;                                        // 0x05E0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_MaxHP;                                             // 0x05E8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NickName;                                          // 0x05F0 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton;                          // 0x05F8 (size: 0x8)
    TSoftObjectPtr<UPalIndividualCharacterParameter> lastBindedIndividualParam;       // 0x0600 (size: 0x30)
    FWBP_IngameMenu_PalBox_PalList_COnClicked OnClicked;                              // 0x0630 (size: 0x10)
    void OnClicked(class UPalIndividualCharacterSlot* targetSlot);
    FWBP_IngameMenu_PalBox_PalList_COnHovered OnHovered;                              // 0x0640 (size: 0x10)
    void OnHovered(class UPalIndividualCharacterSlot* Slot);
    class UPalIndividualCharacterSlot* targetSlot;                                    // 0x0650 (size: 0x8)
    FWBP_IngameMenu_PalBox_PalList_COnUnhovered OnUnhovered;                          // 0x0658 (size: 0x10)
    void OnUnhovered();
