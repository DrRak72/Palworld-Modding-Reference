#ifndef UE4SS_SDK_BP_SkillEffect_DarkTornado_HPP
#define UE4SS_SDK_BP_SkillEffect_DarkTornado_HPP

class ABP_SkillEffect_DarkTornado_C : public ABP_SkillEffectBase_C
{
    ...
    float Up Offset;                                                                  // 0x0458 (size: 0x4)
    ...
    void ExecuteUbergraph_BP_SkillEffect_DarkTornado(int32 EntryPoint);
}; // Size: 0x45C
