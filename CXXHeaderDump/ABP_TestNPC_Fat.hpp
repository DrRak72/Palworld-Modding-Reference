#ifndef UE4SS_SDK_ABP_TestNPC_Fat_HPP
#define UE4SS_SDK_ABP_TestNPC_Fat_HPP
...
class UABP_TestNPC_Fat_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_TestNPC_Fat(int32 EntryPoint);
}; // Size: 0x8A0
