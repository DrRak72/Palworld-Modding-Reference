#ifndef UE4SS_SDK_BP_BuildObject_RepairBench_HPP
#define UE4SS_SDK_BP_BuildObject_RepairBench_HPP

class ABP_BuildObject_RepairBench_C : public APalBuildObject
{
    class UPalMapObjectRepairItemParameterComponent* RepairItemParameter;             // 0x0580 (size: 0x8)
    class UBP_WorkVisualFX_C* BP_WorkVisualFX;                                        // 0x0588 (size: 0x8)
