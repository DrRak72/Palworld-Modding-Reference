#ifndef UE4SS_SDK_ABP_ColorfulBird_Implementation_HPP
#define UE4SS_SDK_ABP_ColorfulBird_Implementation_HPP
...
class UABP_ColorfulBird_Implementation_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_ColorfulBird_Implementation(int32 EntryPoint);
}; // Size: 0x708
