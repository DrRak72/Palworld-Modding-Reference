#ifndef UE4SS_SDK_BP_BuildObject_Shelf02_Iron_HPP
#define UE4SS_SDK_BP_BuildObject_Shelf02_Iron_HPP

class ABP_BuildObject_Shelf02_Iron_C : public APalBuildObject
{
    class UPalMapObjectItemChestParameterComponent* PalMapObjectItemChestParameter;   // 0x0580 (size: 0x8)
    class UStaticMeshComponent* SM_TV_Board;                                          // 0x0588 (size: 0x8)
