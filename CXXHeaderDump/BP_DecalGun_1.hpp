#ifndef UE4SS_SDK_BP_DecalGun_1_HPP
#define UE4SS_SDK_BP_DecalGun_1_HPP

class ABP_DecalGun_1_C : public ABP_DecalGun_Base_C
{
    ...
    void ExecuteUbergraph_BP_DecalGun_1(int32 EntryPoint);
}; // Size: 0x599
