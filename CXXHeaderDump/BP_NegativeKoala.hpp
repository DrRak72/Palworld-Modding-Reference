#ifndef UE4SS_SDK_BP_NegativeKoala_HPP
#define UE4SS_SDK_BP_NegativeKoala_HPP

class ABP_NegativeKoala_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsSphereComponent* PalBodyPartsSphere2;                          // 0x0A10 (size: 0x8)
