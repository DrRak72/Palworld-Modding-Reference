#ifndef UE4SS_SDK_BP_BuildObject_TableSide01_Iron_HPP
#define UE4SS_SDK_BP_BuildObject_TableSide01_Iron_HPP

class ABP_BuildObject_TableSide01_Iron_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_SideTable;                                         // 0x0580 (size: 0x8)
