#ifndef UE4SS_SDK_BP_BuildObject_BlastFurnace4_HPP
#define UE4SS_SDK_BP_BuildObject_BlastFurnace4_HPP

class ABP_BuildObject_BlastFurnace4_C : public APalBuildObject
{
