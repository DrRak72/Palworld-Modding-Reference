#ifndef UE4SS_SDK_BP_DecalBullet_1_HPP
#define UE4SS_SDK_BP_DecalBullet_1_HPP

class ABP_DecalBullet_1_C : public ABP_AttackBulletBase_C
{
    ...
    void ExecuteUbergraph_BP_DecalBullet_1(int32 EntryPoint);
}; // Size: 0x380
