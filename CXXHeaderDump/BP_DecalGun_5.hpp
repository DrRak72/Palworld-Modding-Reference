#ifndef UE4SS_SDK_BP_DecalGun_5_HPP
#define UE4SS_SDK_BP_DecalGun_5_HPP

class ABP_DecalGun_5_C : public ABP_DecalGun_Base_C
{
    ...
    void ExecuteUbergraph_BP_DecalGun_5(int32 EntryPoint);
}; // Size: 0x599
