enum class ECommonSessionOnlineMode {
    Offline = 0,
    LAN = 1,
    Online = 2,
...
enum class ECommonUserAvailability {
    Unknown = 0,
    NowAvailable = 1,
    PossiblyAvailable = 2,
...
enum class ECommonUserInitializationState {
    Unknown = 0,
    DoingInitialLogin = 1,
    DoingNetworkLogin = 2,
    FailedtoLogin = 3,
...
enum class ECommonUserOnlineContext {
    Game = 0,
    Default = 1,
    Service = 2,
    ServiceOrDefault = 3,
...
enum class ECommonUserPrivilegeResult {
    Unknown = 0,
    Available = 1,
    UserNotLoggedIn = 2,
    LicenseInvalid = 3,
