#ifndef UE4SS_SDK_ABP_BerryGoat_Implementation_HPP
#define UE4SS_SDK_ABP_BerryGoat_Implementation_HPP
...
class UABP_BerryGoat_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x0540 (size: 0x250)
    ...
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x07D0 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x07F0 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x08B8 (size: 0xC8)
