#ifndef UE4SS_SDK_BP_BuildObject_Light_LightPole02_HPP
#define UE4SS_SDK_BP_BuildObject_Light_LightPole02_HPP

class ABP_BuildObject_Light_LightPole02_C : public ABP_BuildObject_Lamp_Base_C
{
    class UStaticMeshComponent* SM_LightPole_A4;                                      // 0x0590 (size: 0x8)
