#ifndef UE4SS_SDK_BP_BuildObject_Wood_WindowWall_HPP
#define UE4SS_SDK_BP_BuildObject_Wood_WindowWall_HPP

class ABP_BuildObject_Wood_WindowWall_C : public APalBuildObject
{
    ...
    class UStaticMeshComponent* SM_Wall_Wood;                                         // 0x0598 (size: 0x8)
