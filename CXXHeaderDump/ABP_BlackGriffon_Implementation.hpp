...
class UABP_BlackGriffon_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_Root AnimGraphNode_Root_2;                                              // 0x0450 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_2;                        // 0x0470 (size: 0xC8)
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x0540 (size: 0x250)
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x0790 (size: 0x20)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x07B0 (size: 0x20)
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x07D0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x0A20 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x0C70 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x0C90 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x0D58 (size: 0xC8)
