#ifndef UE4SS_SDK_ABP_MushroomDragon_Inplementation_HPP
#define UE4SS_SDK_ABP_MushroomDragon_Inplementation_HPP
...
class UABP_MushroomDragon_Inplementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_MushroomDragon_Inplementation(int32 EntryPoint);
}; // Size: 0xC78
