...
class UEditableTextBox : public UWidget
{
    ...
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x1046 (size: 0x1)
    ...
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x104A (size: 0x1)
...
class USpinBox : public UWidget
{
    ...
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x07E8 (size: 0x1)
    float MinDesiredWidth;                                                            // 0x07EC (size: 0x4)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x07F0 (size: 0x1)
