...
class UWBP_Map_Base_C : public UPalUIWorldMap
{
    ...
    FName TabActionName;                                                              // 0x04B0 (size: 0x8)
    FVector Min Land Scape Position;                                                  // 0x04B8 (size: 0x18)
    FVector Max Land Scape Position;                                                  // 0x04D0 (size: 0x18)
    TMap<class FGuid, class UWBP_WorldMap_IconBase_NoDesign_C*> CreatedIconMap;       // 0x04E8 (size: 0x50)
    TMap<class UPalLocationPoint*, class FGuid> DeathMarkMap;                         // 0x0538 (size: 0x50)
    TArray<class UWBP_Map_IconDeath_C*> DeathMarks;                                   // 0x0588 (size: 0x10)
    TArray<class UWBP_Map_IconTower_C*> BossTowerIcons;                               // 0x0598 (size: 0x10)
    bool CustomMarkMode;                                                              // 0x05A8 (size: 0x1)
    bool FilterOpened;                                                                // 0x05A9 (size: 0x1)
    class UWBP_WorldMap_IconBase_NoDesign_C* CurrentSetupIcon;                        // 0x05B0 (size: 0x8)
    bool For Respawn;                                                                 // 0x05B8 (size: 0x1)
    TArray<class UWBP_Map_IconPlayer_C*> PlayerIcons;                                 // 0x05C0 (size: 0x10)
    bool Can Fast Travel;                                                             // 0x05D0 (size: 0x1)
    bool IsInitSelect;                                                                // 0x05D1 (size: 0x1)
    TSet<EPalLocationType> FilterIconTypes;                                           // 0x05D8 (size: 0x50)
    FDataTableRowHandle FTMsgID;                                                      // 0x0628 (size: 0x10)
    FDataTableRowHandle RespawnMsgID;                                                 // 0x0638 (size: 0x10)
    TArray<class UWBP_Map_IconBoss_C*> BossIcons;                                     // 0x0648 (size: 0x10)
    FName DismantalActionName;                                                        // 0x0658 (size: 0x8)
    FDataTableRowHandle InitSelectMsgID;                                              // 0x0660 (size: 0x10)
