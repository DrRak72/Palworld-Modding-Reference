#ifndef UE4SS_SDK_BP_DecalBullet_2_HPP
#define UE4SS_SDK_BP_DecalBullet_2_HPP

class ABP_DecalBullet_2_C : public ABP_AttackBulletBase_C
{
    ...
    void ExecuteUbergraph_BP_DecalBullet_2(int32 EntryPoint);
}; // Size: 0x380
