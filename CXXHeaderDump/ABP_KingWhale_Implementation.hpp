#ifndef UE4SS_SDK_ABP_KingWhale_Implementation_HPP
#define UE4SS_SDK_ABP_KingWhale_Implementation_HPP
...
class UABP_KingWhale_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x0A70 (size: 0x20)
    ...
    void ExecuteUbergraph_ABP_KingWhale_Implementation(int32 EntryPoint);
}; // Size: 0xC78
