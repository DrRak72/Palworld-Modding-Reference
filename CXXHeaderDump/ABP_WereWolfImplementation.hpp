#ifndef UE4SS_SDK_ABP_WereWolfImplementation_HPP
#define UE4SS_SDK_ABP_WereWolfImplementation_HPP
...
class UABP_WereWolfImplementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_WereWolfImplementation(int32 EntryPoint);
}; // Size: 0xC78
