#ifndef UE4SS_SDK_BP_BuildObject_BathTub_Stone_HPP
#define UE4SS_SDK_BP_BuildObject_BathTub_Stone_HPP

class ABP_BuildObject_BathTub_Stone_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_bathtub_Set;                                       // 0x0580 (size: 0x8)
