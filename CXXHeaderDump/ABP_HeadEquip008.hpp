#ifndef UE4SS_SDK_ABP_HeadEquip008_HPP
#define UE4SS_SDK_ABP_HeadEquip008_HPP
...
class UABP_HeadEquip008_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_HeadEquip008(int32 EntryPoint);
}; // Size: 0x5070
