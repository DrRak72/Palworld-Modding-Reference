#ifndef UE4SS_SDK_BP_BuildObject_OlympicCauldron_HPP
#define UE4SS_SDK_BP_BuildObject_OlympicCauldron_HPP

class ABP_BuildObject_OlympicCauldron_C : public APalBuildObject
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0580 (size: 0x8)
    class UNiagaraComponent* Fire;                                                    // 0x0588 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0590 (size: 0x8)
    class UPalMapObjectBaseCampPassiveEffectWorkSpeedParameterComponent* BaseCampPassiveEffectWorkSpeedParameter; // 0x0598 (size: 0x8)
