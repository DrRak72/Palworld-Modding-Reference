...
class UWBP_InventoryEquipment_StatusUpButton_C : public UUserWidget
{
    ...
    class UImage* Focus;                                                              // 0x0290 (size: 0x8)
    class UImage* FocusGrd;                                                           // 0x0298 (size: 0x8)
    class UHorizontalBox* HorizontalBox_3;                                            // 0x02A0 (size: 0x8)
    ...
    FWBP_InventoryEquipment_StatusUpButton_COnClicked OnClicked;                      // 0x02C0 (size: 0x10)
    void OnClicked();
    bool IsAlreadyActive;                                                             // 0x02D0 (size: 0x1)
