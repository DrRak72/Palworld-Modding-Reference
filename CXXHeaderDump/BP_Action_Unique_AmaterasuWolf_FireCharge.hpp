#ifndef UE4SS_SDK_BP_Action_Unique_AmaterasuWolf_FireCharge_HPP
#define UE4SS_SDK_BP_Action_Unique_AmaterasuWolf_FireCharge_HPP

class UBP_Action_Unique_AmaterasuWolf_FireCharge_C : public UBP_ActionUniqueAttackBase_C
{
    ...
    void ExecuteUbergraph_BP_Action_Unique_AmaterasuWolf_FireCharge(int32 EntryPoint);
}; // Size: 0x230
