...
class UMovieSceneLiveLinkSection : public UMovieSceneSection
{
    ...
    TArray<FName> CurveNames;                                                         // 0x0210 (size: 0x10)
    TArray<FMovieSceneFloatChannel> PropertyFloatChannels;                            // 0x0220 (size: 0x10)
...
{
    TSubclassOf<class ULiveLinkRole> TrackRole;                                       // 0x00D0 (size: 0x8)
