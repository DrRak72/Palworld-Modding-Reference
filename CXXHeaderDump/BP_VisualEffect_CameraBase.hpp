...
class UBP_VisualEffect_CameraBase_C : public UPalVisualEffectBase
{
    ...
    double FadeInTime;                                                                // 0x0070 (size: 0x8)
    double FadeOutTime;                                                               // 0x0078 (size: 0x8)
    double TimeEventTime;                                                             // 0x0080 (size: 0x8)
    double Weight;                                                                    // 0x0088 (size: 0x8)
    FTimerHandle FadeInTimerHanhdle;                                                  // 0x0090 (size: 0x8)
    FTimerHandle FadeOutTimerHanhdle;                                                 // 0x0098 (size: 0x8)
