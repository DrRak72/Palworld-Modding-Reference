...
class UBP_VisualEffect_SelfDestructEmissive_C : public UPalVisualEffectBase
{
    ...
    FMaterialParameterInfo Material Parameter Info;                                   // 0x0070 (size: 0x10)
    bool isBlinking;                                                                  // 0x0080 (size: 0x1)
    double ElapsedTime;                                                               // 0x0088 (size: 0x8)
    double DefaultEmissiveDuration;                                                   // 0x0090 (size: 0x8)
    double DefaultNoEmissiveDuration;                                                 // 0x0098 (size: 0x8)
    double MinEmissiveDuration;                                                       // 0x00A0 (size: 0x8)
    double DecayRateOfEmissiveTime;                                                   // 0x00A8 (size: 0x8)
    bool IsEndAction;                                                                 // 0x00B0 (size: 0x1)
    class UNiagaraComponent* NiagaraEffect;                                           // 0x00B8 (size: 0x8)
