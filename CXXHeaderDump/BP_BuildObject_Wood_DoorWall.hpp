...
class ABP_BuildObject_Wood_DoorWall_C : public APalBuildObject
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0580 (size: 0x8)
    class UBoxComponent* AffectNavigationBox;                                         // 0x0588 (size: 0x8)
    class UBoxComponent* FrameCollision_02;                                           // 0x0590 (size: 0x8)
    class UBoxComponent* FrameCollision_01;                                           // 0x0598 (size: 0x8)
    ...
    float _______RotateDoor_EBE7A56643BDC6B53DC2B5AB1AB5D8C1;                         // 0x05E0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ________Direction_EBE7A56643BDC6B53DC2B5AB1AB5D8C1; // 0x05E4 (size: 0x1)
