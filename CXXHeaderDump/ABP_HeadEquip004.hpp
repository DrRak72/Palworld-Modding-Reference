#ifndef UE4SS_SDK_ABP_HeadEquip004_HPP
#define UE4SS_SDK_ABP_HeadEquip004_HPP
...
class UABP_HeadEquip004_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_HeadEquip004(int32 EntryPoint);
}; // Size: 0x5070
