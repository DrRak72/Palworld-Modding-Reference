#ifndef UE4SS_SDK_ABP_LazyDragon_Implementation_HPP
#define UE4SS_SDK_ABP_LazyDragon_Implementation_HPP
...
class UABP_LazyDragon_Implementation_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_LazyDragon_Implementation(int32 EntryPoint);
}; // Size: 0x9B8
