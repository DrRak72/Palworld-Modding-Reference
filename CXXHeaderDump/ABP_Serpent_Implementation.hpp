#ifndef UE4SS_SDK_ABP_Serpent_Implementation_HPP
#define UE4SS_SDK_ABP_Serpent_Implementation_HPP
...
class UABP_Serpent_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x06E8 (size: 0x20)
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x0708 (size: 0x20)
    FAnimNode_LookAt AnimGraphNode_LookAt_3;                                          // 0x0730 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x0980 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x0BD0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x0E20 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x1070 (size: 0x20)
    FVector LookAtWorldLocation;                                                      // 0x1090 (size: 0x18)
