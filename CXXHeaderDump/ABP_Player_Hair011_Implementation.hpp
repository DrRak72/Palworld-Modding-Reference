#ifndef UE4SS_SDK_ABP_Player_Hair011_Implementation_HPP
#define UE4SS_SDK_ABP_Player_Hair011_Implementation_HPP
...
class UABP_Player_Hair011_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_3;                            // 0x0450 (size: 0x790)
    ...
    FKawaiiPhysicsSettings PhysicsSetting;                                            // 0x22F0 (size: 0x18)
    double Alpha;                                                                     // 0x2308 (size: 0x8)

    void HairLayer(FPoseLink InPose, FPoseLink& HairLayer);
    void AnimGraph(FPoseLink& AnimGraph);
    void ExecuteUbergraph_ABP_Player_Hair011_Implementation(int32 EntryPoint);
}; // Size: 0x2310
