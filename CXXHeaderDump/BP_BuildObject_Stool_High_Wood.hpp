#ifndef UE4SS_SDK_BP_BuildObject_Stool_High_Wood_HPP
#define UE4SS_SDK_BP_BuildObject_Stool_High_Wood_HPP

class ABP_BuildObject_Stool_High_Wood_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_high_stool;                                        // 0x0580 (size: 0x8)
