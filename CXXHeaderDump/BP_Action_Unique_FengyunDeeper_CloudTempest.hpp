#ifndef UE4SS_SDK_BP_Action_Unique_FengyunDeeper_CloudTempest_HPP
#define UE4SS_SDK_BP_Action_Unique_FengyunDeeper_CloudTempest_HPP

class UBP_Action_Unique_FengyunDeeper_CloudTempest_C : public UBP_ActionUniqueAttackBase_C
{
    ...
    void OnEndAction();
    void ExecuteUbergraph_BP_Action_Unique_FengyunDeeper_CloudTempest(int32 EntryPoint);
}; // Size: 0x280
