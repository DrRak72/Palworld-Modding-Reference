#ifndef UE4SS_SDK_BP_BuildObject_Stool01_Iron_HPP
#define UE4SS_SDK_BP_BuildObject_Stool01_Iron_HPP

class ABP_BuildObject_Stool01_Iron_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_AVI_Stool_02;                                      // 0x0580 (size: 0x8)
