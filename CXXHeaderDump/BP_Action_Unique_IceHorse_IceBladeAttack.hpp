#ifndef UE4SS_SDK_BP_Action_Unique_IceHorse_IceBladeAttack_HPP
#define UE4SS_SDK_BP_Action_Unique_IceHorse_IceBladeAttack_HPP

class UBP_Action_Unique_IceHorse_IceBladeAttack_C : public UBP_ActionUniqueAttackBase_C
{
    ...
    void ExecuteUbergraph_BP_Action_Unique_IceHorse_IceBladeAttack(int32 EntryPoint);
}; // Size: 0x230
