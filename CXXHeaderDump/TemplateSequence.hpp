...
{
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x0298 (size: 0x20)
    class UTemplateSequencePlayer* SequencePlayer;                                    // 0x02B8 (size: 0x8)
    FSoftObjectPath TemplateSequence;                                                 // 0x02C0 (size: 0x20)
    FTemplateSequenceBindingOverrideData BindingOverride;                             // 0x02E0 (size: 0xC)
...
class UCameraAnimationSequenceCameraStandIn : public UObject
{
    ...
    FCameraFocusSettings FocusSettings;                                               // 0x0750 (size: 0x68)
    float CurrentFocalLength;                                                         // 0x07B8 (size: 0x4)
    float CurrentAperture;                                                            // 0x07BC (size: 0x4)
    float CurrentFocusDistance;                                                       // 0x07C0 (size: 0x4)
