...
class UBP_VisualEffect_SpawnFromBallEmissive_C : public UPalVisualEffectBase
{
    ...
    double EndEmission;                                                               // 0x0088 (size: 0x8)
    double StartEmissive;                                                             // 0x0090 (size: 0x8)
    FName flagName;                                                                   // 0x0098 (size: 0x8)
    double ScaleTime;                                                                 // 0x00A0 (size: 0x8)
    double ScaleTimer;                                                                // 0x00A8 (size: 0x8)
    bool IsScaleEnable;                                                               // 0x00B0 (size: 0x1)
    FTimerHandle TickTimerHandle;                                                     // 0x00B8 (size: 0x8)
    double TickInterval;                                                              // 0x00C0 (size: 0x8)
