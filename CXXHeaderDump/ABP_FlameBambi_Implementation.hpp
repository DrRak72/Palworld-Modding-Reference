#ifndef UE4SS_SDK_ABP_FlameBambi_Implementation_HPP
#define UE4SS_SDK_ABP_FlameBambi_Implementation_HPP
...
class UABP_FlameBambi_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_FlameBambi_Implementation(int32 EntryPoint);
}; // Size: 0xC78
