#ifndef UE4SS_SDK_BP_RobinHood_HPP
#define UE4SS_SDK_BP_RobinHood_HPP

class ABP_RobinHood_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule4;                        // 0x0A10 (size: 0x8)
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule3;                        // 0x0A18 (size: 0x8)
