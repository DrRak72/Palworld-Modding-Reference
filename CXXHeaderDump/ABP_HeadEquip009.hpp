#ifndef UE4SS_SDK_ABP_HeadEquip009_HPP
#define UE4SS_SDK_ABP_HeadEquip009_HPP
...
class UABP_HeadEquip009_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_HeadEquip009(int32 EntryPoint);
}; // Size: 0x5070
