#ifndef UE4SS_SDK_BP_BuildObject_Shelf_Hang01_Wood_HPP
#define UE4SS_SDK_BP_BuildObject_Shelf_Hang01_Wood_HPP

class ABP_BuildObject_Shelf_Hang01_Wood_C : public APalBuildObject
{
    class UPalMapObjectItemChestParameterComponent* PalMapObjectItemChestParameter;   // 0x0580 (size: 0x8)
    class UStaticMeshComponent* SM_cup_board_04;                                      // 0x0588 (size: 0x8)
