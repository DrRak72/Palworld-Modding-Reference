...
class UWBP_PalDamageText_C : public UPalUIDamageTextBase
{
    ...
    class UWidgetAnimation* In;                                                       // 0x0450 (size: 0x8)
    class UCanvasPanel* CanvasPanel_0;                                                // 0x0458 (size: 0x8)
    class UBP_PalTextBlock_C* Text_DamageValue;                                       // 0x0460 (size: 0x8)
    int32 totalDamage;                                                                // 0x0468 (size: 0x4)
    double animeSpeedScale;                                                           // 0x0470 (size: 0x8)
    EPalDamageTextType textType;                                                      // 0x0478 (size: 0x1)
    double interpolationLength;                                                       // 0x0480 (size: 0x8)
    FVector2D OffsetPosition;                                                         // 0x0488 (size: 0x10)
    FVector2D randomizeOffset;                                                        // 0x0498 (size: 0x10)
