#ifndef UE4SS_SDK_WBP_BossBattle_BossCut01_HPP
#define UE4SS_SDK_WBP_BossBattle_BossCut01_HPP

class UWBP_BossBattle_BossCut01_C : public UUserWidget
{
    ...
    class UImage* MainLight;                                                          // 0x02A0 (size: 0x8)
    class URetainerBox* RetainerBox_0;                                                // 0x02A8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_MainName;                                          // 0x02B0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_SubName;                                           // 0x02B8 (size: 0x8)
