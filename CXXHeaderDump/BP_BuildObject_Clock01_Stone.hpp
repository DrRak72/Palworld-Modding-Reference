#ifndef UE4SS_SDK_BP_BuildObject_Clock01_Stone_HPP
#define UE4SS_SDK_BP_BuildObject_Clock01_Stone_HPP

class ABP_BuildObject_Clock01_Stone_C : public APalBuildObject
{
    class UStaticMeshComponent* SM_Floor_Clock_comb;                                  // 0x0580 (size: 0x8)
