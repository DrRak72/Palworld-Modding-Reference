#ifndef UE4SS_SDK_BP_BuildObject_Shelf01_Stone_HPP
#define UE4SS_SDK_BP_BuildObject_Shelf01_Stone_HPP

class ABP_BuildObject_Shelf01_Stone_C : public APalBuildObject
{
    class UPalMapObjectItemChestParameterComponent* PalMapObjectItemChestParameter;   // 0x0580 (size: 0x8)
    class UStaticMeshComponent* SM_books_01;                                          // 0x0588 (size: 0x8)
    class UStaticMeshComponent* SM_bookcase_low;                                      // 0x0590 (size: 0x8)
