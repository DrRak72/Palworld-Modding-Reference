#ifndef UE4SS_SDK_BP_BuildObject_BlastFurnace3_HPP
#define UE4SS_SDK_BP_BuildObject_BlastFurnace3_HPP

class ABP_BuildObject_BlastFurnace3_C : public APalBuildObject
{
    class UPalWorkFacingComponent* WorkFacing;                                        // 0x0580 (size: 0x8)
    class UStaticMeshComponent* SM_BlastFurnaceElectric;                              // 0x0588 (size: 0x8)
