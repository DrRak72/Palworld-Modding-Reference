...
class USynthComponent : public USceneComponent
{
    ...
    FSoundAttenuationSettings AttenuationOverrides;                                   // 0x02B0 (size: 0x3C8)
    class USoundConcurrency* ConcurrencySettings;                                     // 0x0678 (size: 0x8)
    TSet<USoundConcurrency*> ConcurrencySet;                                          // 0x0680 (size: 0x50)
    class USoundClass* SoundClass;                                                    // 0x06D0 (size: 0x8)
    class USoundEffectSourcePresetChain* SourceEffectChain;                           // 0x06D8 (size: 0x8)
    class USoundSubmixBase* SoundSubmix;                                              // 0x06E0 (size: 0x8)
    TArray<FSoundSubmixSendInfo> SoundSubmixSends;                                    // 0x06E8 (size: 0x10)
    TArray<FSoundSourceBusSendInfo> BusSends;                                         // 0x06F8 (size: 0x10)
    TArray<FSoundSourceBusSendInfo> PreEffectBusSends;                                // 0x0708 (size: 0x10)
    uint8 bIsUISound;                                                                 // 0x0718 (size: 0x1)
    uint8 bIsPreviewSound;                                                            // 0x0718 (size: 0x1)
    int32 EnvelopeFollowerAttackTime;                                                 // 0x071C (size: 0x4)
    int32 EnvelopeFollowerReleaseTime;                                                // 0x0720 (size: 0x4)
    FSynthComponentOnAudioEnvelopeValue OnAudioEnvelopeValue;                         // 0x0728 (size: 0x10)
    void OnSynthEnvelopeValue(const float EnvelopeValue);
    class USynthSound* Synth;                                                         // 0x0758 (size: 0x8)
    class UAudioComponent* AudioComponent;                                            // 0x0760 (size: 0x8)
...
{
    TWeakObjectPtr<class USynthComponent> OwningSynthComponent;                       // 0x04A0 (size: 0x8)
