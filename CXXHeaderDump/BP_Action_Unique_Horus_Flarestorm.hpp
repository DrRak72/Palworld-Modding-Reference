#ifndef UE4SS_SDK_BP_Action_Unique_Horus_Flarestorm_HPP
#define UE4SS_SDK_BP_Action_Unique_Horus_Flarestorm_HPP

class UBP_Action_Unique_Horus_Flarestorm_C : public UBP_ActionUniqueAttackBase_C
{
    ...
    void OnEndAction();
    void ExecuteUbergraph_BP_Action_Unique_Horus_Flarestorm(int32 EntryPoint);
}; // Size: 0x2B0
