#ifndef UE4SS_SDK_BP_BuildObject_Wood_Gate_HPP
#define UE4SS_SDK_BP_BuildObject_Wood_Gate_HPP

class ABP_BuildObject_Wood_Gate_C : public APalBuildObject
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0580 (size: 0x8)
    class UBoxComponent* PillarAffectNavigationBox1;                                  // 0x0588 (size: 0x8)
    class UBoxComponent* PillarAffectNavigationBox;                                   // 0x0590 (size: 0x8)
    class UBoxComponent* AffectNavigationBox;                                         // 0x0598 (size: 0x8)
    class UStaticMeshComponent* SM_Gate_Base_Wood;                                    // 0x05A0 (size: 0x8)
    class UStaticMeshComponent* SM_Wall_Door1;                                        // 0x05A8 (size: 0x8)
    ...
    class UStaticMeshComponent* SM_Wall_Door;                                         // 0x05C8 (size: 0x8)
    class USceneComponent* Root;                                                      // 0x05D0 (size: 0x8)
    class UBoxComponent* CheckOverlapCollision;                                       // 0x05D8 (size: 0x8)
    float _______RotateDoor_E1DCACF040C38D2FF484C39040DC80F5;                         // 0x05E0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ________Direction_E1DCACF040C38D2FF484C39040DC80F5; // 0x05E4 (size: 0x1)
    ...
    void ExecuteUbergraph_BP_BuildObject_Wood_Gate(int32 EntryPoint);
}; // Size: 0x5F0
