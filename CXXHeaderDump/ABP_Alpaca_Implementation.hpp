#ifndef UE4SS_SDK_ABP_Alpaca_Implementation_HPP
#define UE4SS_SDK_ABP_Alpaca_Implementation_HPP
...
struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    ...
    FName __NameProperty_40;                                                          // 0x0024 (size: 0x8)
    FName __NameProperty_41;                                                          // 0x002C (size: 0x8)
    FAnimNodeFunctionRef __StructProperty_42;                                         // 0x0038 (size: 0x20)
...
class UABP_Alpaca_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LinkedAnimLayer AnimGraphNode_LinkedAnimLayer;                          // 0x0C60 (size: 0xC8)
    FVector LookAtWorldLocation;                                                      // 0x0D28 (size: 0x18)
