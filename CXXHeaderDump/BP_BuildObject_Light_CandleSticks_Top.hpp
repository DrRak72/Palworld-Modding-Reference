#ifndef UE4SS_SDK_BP_BuildObject_Light_CandleSticks_Top_HPP
#define UE4SS_SDK_BP_BuildObject_Light_CandleSticks_Top_HPP

class ABP_BuildObject_Light_CandleSticks_Top_C : public ABP_BuildObject_Lamp_Base_C
{
    class UStaticMeshComponent* SM_Chandelier03;                                      // 0x0590 (size: 0x8)
