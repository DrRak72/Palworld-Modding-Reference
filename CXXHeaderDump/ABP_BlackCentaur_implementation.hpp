#ifndef UE4SS_SDK_ABP_BlackCentaur_implementation_HPP
#define UE4SS_SDK_ABP_BlackCentaur_implementation_HPP
...
class UABP_BlackCentaur_implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_BlackCentaur_implementation(int32 EntryPoint);
}; // Size: 0xC78
