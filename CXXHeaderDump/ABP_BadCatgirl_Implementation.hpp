#ifndef UE4SS_SDK_ABP_BadCatgirl_Implementation_HPP
#define UE4SS_SDK_ABP_BadCatgirl_Implementation_HPP
...
class UABP_BadCatgirl_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x07F8 (size: 0x20)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x0818 (size: 0x20)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x0840 (size: 0x250)
    ...
    void ExecuteUbergraph_ABP_BadCatgirl_Implementation(int32 EntryPoint);
}; // Size: 0xC78
