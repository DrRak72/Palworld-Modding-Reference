#ifndef UE4SS_SDK_BP_DecalBullet_4_HPP
#define UE4SS_SDK_BP_DecalBullet_4_HPP

class ABP_DecalBullet_4_C : public ABP_AttackBulletBase_C
{
    ...
    void ExecuteUbergraph_BP_DecalBullet_4(int32 EntryPoint);
}; // Size: 0x380
